...
var schedule = [];
var schduleTime = $("h3").val();
console.log($("h3").val())

function start(){
    if ( moment().format("h a") > schduleTime ){
    console.log("you missed this event");
    $("h3").addClass("text-primary");
    }
    else if ( moment().format("h a") < schduleTime){
        console.log("You have an open schedule!")
    }
